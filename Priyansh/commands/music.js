...
module.exports = {
  config: {
    ...
    description: "Search and download YouTube audio (always MP3 format)",
    commandCategory: "Media",
    usages: "[song name] (downloads audio)",
    cooldowns: 5
  },
  ...
  run: async function ({ api, event, args }) {
    ...
    try {
      const searchResults = await ytSearch(audioName);
  ...
  handleReply: async function ({ api, event, handleReply }) {
    ...
    const format = "audio"; // সবসময় audio
